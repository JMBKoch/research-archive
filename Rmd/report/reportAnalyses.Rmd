...
```{r}
biasAllPars <- allAtOnce + plot_layout(guides = "collect", ncol = 2) & theme(legend.position = "bottom", legend.title = element_blank())
saveRDS(biasAllPars, file = "~/1vs2StepBayesianRegSEM/Rmd/figures/BiasAllPars.Rds")
```
