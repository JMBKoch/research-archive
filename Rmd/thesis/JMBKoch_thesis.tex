...
\caption{\label{tab:unnamed-chunk-6}Conditions under which more than 5\% of replications were removed due to not reaching convergence.}
...
\caption{\label{tab:unnamed-chunk-7}Conditions with on average more than 5\% divergent transitions}
...
\caption{\label{tab:unnamed-chunk-12}Power in selecting non-zero cross-loadings.}
