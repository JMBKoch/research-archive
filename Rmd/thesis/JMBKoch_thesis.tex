...
\caption{\label{fig:unnamed-chunk-4}Mean Power and Type-I-Error Rates in Selecting non-zero Crossloadings. All hyper-parameters of the RHSP are set to 1 in the results presented here.}
\end{figure}
...
\caption{\label{tab:unnamed-chunk-5}Conditions under which more than 5\% of replications were removed due to not reaching convergence.}
...
\caption{\label{tab:unnamed-chunk-6}Conditions with on average more than 5\% divergent transitions}
...
\caption{\label{tab:unnamed-chunk-11}Power in selecting non-zero cross-loadings.}
