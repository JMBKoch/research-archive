...
\hypertarget{bayesian-cfa-and-alternative-shrinkage-priors}{%
\subsection{Bayesian CFA and Alternative Shrinkage Priors}\label{bayesian-cfa-and-alternative-shrinkage-priors}}
