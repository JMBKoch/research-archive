...
\caption{\label{fig:unnamed-chunk-3}SVNP: Mean Absolute Bias in the Model Parameters (N = 100). The first parameter of all sets of parameters were used to represent all other parameters of a set, e.g., cross-loading 1 was plottet representative for cross-loading 1 and 6.}
\end{figure}
