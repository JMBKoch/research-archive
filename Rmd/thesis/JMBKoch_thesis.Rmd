...
In Least Squared Residuals estimation the estimates of $\beta$ are obtained by minimizing the sum of squared residuals.
...
- tabel: Overzicht condities SVNP

## RHSP: Prior Conditions 

- tabel: Overzicht condities RHSP
