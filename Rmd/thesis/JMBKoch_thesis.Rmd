...
*Regularization*, *Regularized SEM*, *Bayesian CFA*, *Small Variance Normal Prior*, *Regularized Horseshoe Prior*.
...
Confirmatory Factor Analysis [CFA, @bollen_structural_1989] is an essential tool for modeling measurement structures, falling under the class of Structural Equation Models (SEM). For every individual i, the scores on a vector of p observed indicators $y_i$:
