...
```{r, , dev='cairo_pdf', include=T, echo=F, warning=F, fig.cap="SVNP: Mean Absolute Bias in the Model Parameters (N = 100). The first parameter of all sets of parameters were used to represent all other parameters of a set, e.g., cross-loading 1 was plottet representative for cross-loading 1 and 6.", fig.height=9}
# load plot
library(patchwork)
